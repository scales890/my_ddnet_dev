...
MACRO_CONFIG_INT(SvMovingFreezeQuads, sv_moving_freeze_quads, 0, 0, 1, CFGFLAG_SERVER | CFGFLAG_GAME, "Enable moving freeze quad collision (set via embedded map settings only)")
...
MACRO_CONFIG_INT(SvLoginRequireForChat, sv_login_require_for_chat, 0, 0, 3600, CFGFLAG_SERVER, "Chat restriction for players who are not logged in (0=off, 1=block all, 2+=minimum seconds between messages)")
MACRO_CONFIG_INT(SvLoginRequireForVote, sv_login_require_for_vote, 0, 0, 1, CFGFLAG_SERVER, "Block voting for spectators who are not logged in")
